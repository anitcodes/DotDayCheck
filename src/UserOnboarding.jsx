...
function MultipleChoiceOption({ option, isSelected, onClick, description }) {
  return (
    <button
      onClick={onClick}
      className={`w-full p-3 sm:p-4 rounded-xl border-2 text-left transition-all hover:shadow-md ${
        isSelected ? "border-pink-500 bg-pink-50 shadow-lg" : "border-gray-200 hover:border-pink-300 hover:bg-pink-50"
      }`}
    >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className={`w-full p-3 sm:p-4 rounded-xl border-2 text-center transition-all ${
                    !formData.lastPeriodKnown
            ...
            <div className="space-y-6">
                ...
                {[3, 4, 5, 6, 7].map((days) => (
                  <button
                    ...
                    className={`p-2 sm:p-3 rounded-xl border-2 text-center transition-all ${
                      formData.periodDuration === days.toString()
              ...
              <button
                ...
                className={`w-full p-3 rounded-xl border-2 text-center transition-all ${
                  formData.periodDuration === "unknown"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3">
                {[24, 26, 28, 30, 32, 35].map((days) => (
                  <button
                    ...
                    className={`p-2 sm:p-3 rounded-xl border-2 text-center transition-all ${
                      formData.cycleLength === days.toString()
                        ? "border-pink-500 bg-pink-50"
                        : "border-gray-200 hover:border-pink-300"
                    }`}
                  >
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 py-4 sm:py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 px-4">Welcome to FlowTracker</h1>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-6 sm:mt-8 max-w-4xl mx-auto gap-4 sm:gap-0 px-4">
          <button
            ...
            className={`flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold transition-all order-2 sm:order-1 ${
              currentStep === 1
          ...
          <div className="flex gap-3 order-1 sm:order-2 w-full sm:w-auto">
            ...
            {currentStep < TOTAL_STEPS ? (
              <button
                ...
                className={`flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold transition-all ${
                  currentStep <= 6 && !isStepValid()
